...
const defaultSiteConfig: SiteConfig = {
  ...
  footerDescription: "Nuestra marca es líder en gorras de colección urbana de alta gama y diseño conceptual con autenticación NFC y acabados premium de nivel internacional.",
